                    ...
                    <div className="flex justify-between h-16">
                                ...
                                <Dropdown>
                                    <Dropdown.Trigger>
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className={`${s.primary_text} inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md  `}
                                            >
                                                {user.name}
                        ...
                        <div className="-me-2 flex items-center sm:hidden">
                            <button
                                ...
                                className={`inline-flex items-center justify-center p-2 rounded-md ${s.secondary_text} ${s.background}`}
                            >
